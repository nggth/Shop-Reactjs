...
const data = [
  {
    ...
    fields: {
      ...
      extras: [
        ...
        "Turtleneck. Button closing on the neck. Long puffed sleeves. Buttoned cuffs. Elastic waist.",
        "Side length 73.8 cm.",
        "Back length 95.3 cm."
      ],
      images: [
  ...
  },
  {
    ...
    fields: {
      ...
      extras: [
        ...
        "Button fastening on the front section. Bow on the waist.",
        "Side length 99.5 cm.",
        "Back length 126.5 cm."
      ],
      images: [
        {
          fields: {
  ...
  },
  {
    ...
    fields: {
      ...
      extras: [
        ...
        "Bow fastening on the neck.",
        "Long sleeve with buttoned cuffs. Long puffed sleeves. Inner lining.",
        "Side length 69.0 cm.",
        "Back length 93.5 cm."
      ],
      images: [
  ...
  },
  {
    ...
    fields: {
      ...
      extras: [
        ...
        "Flared short sleeve. Adjustable cord. Inner lining.",
        "Side length 84.0 cm.",
        "Back length 124.0 cm."
      ],
      images: [
        {
          fields: {
  ...
  },
  {
    ...
    fields: {
      ...
      extras: [
        ...
        "Button fastening on the front section.",
        "Side length 102.9 cm.",
        "Back length 122.5 cm."
      ],
      images: [
        {
          fields: {
